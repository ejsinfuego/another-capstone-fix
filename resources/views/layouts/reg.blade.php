            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navigation" style="margin:0; padding:0; padding-left:20px;">
                        <li class="navigation-items"><a href="{{route('dashboard')}}" class="links">Dashboard</a></li>
                        <li class="navigation-items"><a href="{{route('employee')}}" class="links" >Manage Employee</a></li>
                        <li class="navigation-items"><a href="{{route('history')}}" class="links" >Transaction History</a></li>
